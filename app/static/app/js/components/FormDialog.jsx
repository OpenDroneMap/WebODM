...
class FormDialog extends React.Component {
  ...
  static propTypes = {
    ...
    deleteWarning: PropTypes.oneOfType([PropTypes.string, PropTypes.bool]),
    show: PropTypes.bool,
  };
  ...
  componentWillUnmount() {
    ...
    $(this.modal).off("hidden.bs.modal hidden.bs.modal").modal("hide");
  }
  ...
  handleDelete() {
    if (this.props.deleteAction) {
      if (
        this.props.deleteWarning === false ||
        window.confirm(this.props.deleteWarning)
      ) {
