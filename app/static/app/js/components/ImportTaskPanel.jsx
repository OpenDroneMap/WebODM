  ...
  handleConfirmImportUrl = () => {
    ...
    $.post(`/api/projects/${this.props.projectId}/tasks/import`, {
      ...
      .fail(() => {
        this.setState({
          importingFromUrl: false,
          error: _("Cannot import from URL. Check your internet connection."),
        });
      });
  };
  ...
  render() {
    return (
      <div
        ...
        className="import-task-panel theme-background-highlight"
      >
        <div className="form-horizontal">
          ...
          <p>
            <Trans params={{ arrow: '<i class="fas fa-arrow-alt-right"></i>' }}>
              {_(
                "You can import .zip files that have been exported from existing tasks via Download Assets %(arrow)s All Assets."
              )}
            </Trans>
          </p>
          ...
          {this.state.typeUrl ? (
            <div className="form-inline">
              <div className="form-group">
                <input
                  disabled={this.state.importingFromUrl}
                ...
                />
                <button
                  onClick={this.handleConfirmImportUrl}
                  disabled={
                    this.state.importUrl.length < 4 ||
                    this.state.importingFromUrl
                  }
                  className="btn-import btn btn-primary"
                >
                  <i class="fas fa-cloud-download-alt"></i> {_("Import")}
                </button>
              </div>
            </div>
          ) : (
