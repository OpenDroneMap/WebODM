        ...
        this.setState({
          ...
          <li>${_(
            "The min-num-features task option is set too low, try increasing it by 25%"
              ...
              link: `<a href='https://support.dronedeploy.com/v1.0/docs/making-successful-maps' target='_blank'>${_(
                "here"
              )}</a>`,
            }
          ),
            ...
            <div className="col-md-12 no-padding">
              ...
              <div className="mb">
                ...
                <div className="labels">
                  ...
                  {task.auto_processing_node ? "auto" : "manual"})<br />
                </div>
                {Array.isArray(task.options) ? (
                  <div className="labels">
                    <strong>{_("Options:")} </strong>{" "}
                    {this.optionsToList(task.options)}
                    <br />
                  </div>
                ) : (
                  ""
                ...
                <div className="task-warning">
                  ...
                  <Trans
                    params={{
                      ...
                      cloudlink: `<a href='https://www.opendronemap.org/webodm/lightning/' target='_blank'>${_(
              ...
              {showExitedWithCodeOneHints ? (
                <div className="task-warning">
                  ...
                  <div className="inline">
                    <Trans
                      params={{
                        link1: `<a href="https://www.dronedb.app/" target="_blank">DroneDB</a>`,
                        link2: `<a href="https://drive.google.com/drive/u/0/" target="_blank">Google Drive</a>`,
                        open_a_topic: `<a href="http://community.opendronemap.org/c/webodm" target="_blank">${_(
                          "open a topic"
                        )}</a>`,
                      }}
                    >
                      {_(
                        "\"Process exited with code 1\" means that part of the processing failed. Sometimes it's a problem with the dataset, sometimes it can be solved by tweaking the Task Options and sometimes it might be a bug! If you need help, upload your images somewhere like %(link1)s or %(link2)s and %(open_a_topic)s on our community forum, making sure to include a copy of your task's output. Our awesome contributors will try to help you!"
                      )}
                    </Trans>{" "}
      ...
      <div className="task-list-item">
        <div className="row">
          <div className="col-sm-5 name">
            ...
            ></i>{" "}
            <a href="javascript:void(0);" onClick={this.toggleExpanded}>
              {name}
            </a>
          </div>
